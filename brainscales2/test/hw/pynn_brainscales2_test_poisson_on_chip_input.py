...
class TestPoissonOnChipInput(unittest.TestCase):
    ...
    def test_timeframe(self):
        """
        Check that the neurons don't spike before 0 or after self.runtime.
        """
        self.assertGreaterEqual(self.spiketrain1[0], 0)
        self.assertLessEqual(self.spiketrain1[-1], self.runtime)
    ...
    def test_length(self):
        ...
        properties.
        """
        expected_length1 = self.runtime / 1000 * \
            self.bg_props["rate"]
